...
public class RosterManager {
    ...
    /**
     * Command to list students in a given school.
     * Sorted by last name, first name and DOB
     * @param school
     * @param myRoster
     */
    ...
    /**
     * Command to change major of given student
     * @param firstName
     * @param lastName
     * @param DOB
        ...
        while(! (hasQuit && sc.hasNextLine())) {                           //continuously read the line commands until the user quits
            ...
            switch (parsedCommandArguments[0]) {                                //get the current command\
                ...
                case "R": //Remove command
                    ...
                    break;
                case "P": //Print roster by last name first name and DOB
                case "PS": //Print roster by standing
                case "PC": //Print roster by school and major
                    P_Command(parsedCommandArguments[0],myRoster);
                    break;
                case "L": //List students in given school sorted by last, first name and DOB
                    L_Command(parsedCommandArguments[1],myRoster);
                    break;
                case "C": //Change major command
